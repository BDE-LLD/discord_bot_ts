...
export async function create_buttons(client: Client) {
    ...
    if (channel && channel.isTextBased()) {
        ...
        const embed = new EmbedBuilder().setTitle("Authentification").setDescription("Clique sur le bouton ci-dessous pour te connecter avec ton compte 42 et profiter pleinement de ce Discord !");
